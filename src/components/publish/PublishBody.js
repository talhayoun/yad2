...
const PublishBody = ({ onClickPublishing }) => {
    ...
    return (
        <div className="publishbody">
            {connect &&
                <div className="loginmodal-after-connect">
                    <div></div>
                    <p>התחברת בהצלחה</p>
                </div>}
            <h2>אני רוצה לפרסם מודעה בלוח....</h2>
            <div className="publishbody-bigads">
                <PublishBigAd onClickButton={() => setBlackBox(true)} />
            </div>
            ...
            {blackBox && <div className="black-box" onClick={() => setBlackBox(false)}></div>}
            {blackBox &&
                <div className="publishbody-publishbox">
                    <div className="publishbody-publishbox-div">
                        <svg width="34px" height="34px" viewBox="0 0 34 34" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g id="Publish-New-Ad-NADLAN" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <g id="Publish-New-Ad-CATEGORIES-popup-hover-v2" transform="translate(-603.000000, -390.000000)" fillRule="nonzero">
                    ...
                    <p onClick={() => setBlackBox(false)}>X</p>
            ...
            {showModal && <LoginModal setConnect={setConnect} />}
        </div>
    );
};
